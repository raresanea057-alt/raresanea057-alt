...
> Extends [HistNERo (Avram et al., 2024)](https://huggingface.co/datasets/avramandrei/histnero) with a BiLSTM model + rule-based post-processing, benchmarked against Romanian BERT on 5 entity types in historical text.
